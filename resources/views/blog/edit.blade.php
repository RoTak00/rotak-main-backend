        ...
        <form method="POST" action={{ route('blog.update', ['blog' => $blog->id]) }} enctype="multipart/form-data">
            ...
            <div class="form">
                <div class="wrapper">
                    ...
                    <input type="text" name="header" placeholder="Header" value="{{ $blog->header }}" required />
                    <label for="date"> Date </label>
                    <input type="text" name="date" placeholder="Date" value="{{ $blog->date}}"/>
