...
<div class="container">
    ...
    <div class="project-index-container">
        ...
        <div>
            ...
            <form method="POST" action={{ route('project_ideas.reorder') }}>
                @csrf
                <input type="hidden" name="id" value={{ $p->id }}>
                <select name="new_order" id="new_order">
                    @foreach ($project_ideas as $p_ordering)
        ...
        <div class="actions">
            ...
            <form action={{ route('project_ideas.edit', ['project_idea'=> $p->id]) }}>
                <button type="submit"> Edit
                </button>
            </form>


            <form method="POST" action={{ route('project_ideas.destroy', ['project_idea'=> $p->id]) }}>
                @csrf
                @method('DELETE')
    ...
    <div class="project-index-container new">
        <div> </div>
        <div> <a href="{{ route('project_ideas.create') }}">Create new Project Idea</a> </div>
